...
<body style="font-family: Verdana, Geneva, Tahoma, sans-serif;">
    ...
    <div class="blog-container mb30">
        <div class="container">
            ...
            <div class="row blog-main-box mb20">
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 no-padding">
                    <img src="./Images/more-blog-pic1.png" alt="blog" class="img-responsive" />
                </div>
                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                    <h2>Financial uncertainity due to Lockdown????</h2>
                    <p>The current lockdown situation was never anticipated by us and it came as a surprise. It is very unfortunate for all of us to go through these hard times but what is more serious concern is the effect it will have on our future. Should we consider it as a boon or a bane? 
                        
                    Well, we don't have any control over the current situation or the future. But what we can control is how we make the best of this situation and convert it into an opportunity.
                    </p>
                    <a href='blog_1.php' class="btn btn-blog-main">Read More</a>
                </div>
            </div>
        </div>
    </div>
