            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand brand-header" href="/">
                        <img src="./Images/logo.png" height="30px" alt="second income" />
                    </a>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="booking-content">
                        <h2>Partner Us</h2>
                        <p>
                            We have multiple options to partner with us. Choose the best option best suited for you and we will ensure your success with our proven systems and processes. 
                        </p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="panel panel-booking panel-zoom">
                        <i class="fa fa-users"></i>
                        <div class="panel-booking-content">
                            <h3>Associate Partner</h3>
                            <p>If an individual joins us only to refer business leads in his family, personal and social circle, he will be termed as an...</p>
                        </div>
                        <a href='associate_partner.php' class="btn btn-standard-full">Read More</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="panel panel-booking panel-zoom">
                        ...
                        <div class="panel-booking-content">
                            ...
                            <p>If an individual joins us as BP, then he will be authorized to generate leads within his family, personal and social circles...</p>
                        </div>
                        <a href='business_partner.php' class="btn btn-standard-full">Read More</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="panel panel-booking panel-zoom">
                        ...
                        <div class="panel-booking-content">
                            ...
                            <p>A CP will be an existing and established business owner looking for diversification. He can become a franchise owner and...</p>
                        </div>
                        <a href='channel_partner.php' class="btn btn-standard-full">Read More</a>
                    </div>
                </div>
            </div>
            <br />
